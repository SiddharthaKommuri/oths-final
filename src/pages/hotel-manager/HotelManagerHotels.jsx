// HotelManagerHotels.jsx (Exact copy of ManageHotels with name changed)
...
const HotelManagerHotels = () => {
  ...
  return (
    <DashboardLayout title="My Hotels">
...
export default HotelManagerHotels;
